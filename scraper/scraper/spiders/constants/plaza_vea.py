...
COMMERCIAL_ID = "20100070970"
COMMERCIAL_NAME = "plaza_vea"
...
# XPaths para paginación optimizados
XPATH_PAGINATION = '//div[@class="pagination"]'
XPATH_ACTIVE_PAGE = '//span[contains(@class, "pagination__item") and contains(@class, "page-number") and contains(@class, "active")]/text()'
XPATH_NEXT_PAGE_BUTTON = '//span[contains(@class, "pagination__item") and contains(@class, "page-number") and not(contains(@class, "active"))][1]'
XPATH_SPECIFIC_PAGE_BUTTON = '//span[contains(@class, "pagination__item") and contains(@class, "page-number") and not(contains(@class, "active")) and text()="{}"]'
